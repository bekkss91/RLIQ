  ...
  const benefits = [
    {
      ...
      color: "from-mediumGreenAccent to-logoGreen"
    },
    {
    ...
    },
    {
      ...
      color: "from-lightGreenAccent to-mediumGreenAccent"
    }
  ];

  return (
    <section id="benefits" className="py-20 bg-darkBackground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="group relative overflow-hidden">
              <div className="bg-whiteAccent rounded-2xl p-8 border border-lightGreenAccent shadow-lg hover:shadow-2xl transition-all duration-300 h-full relative z-10">
                <div className={`bg-gradient-to-r ${benefit.color} text-darkBackground w-20 h-20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  {benefit.icon}
                </div>
                <h3 className="text-2xl font-bold text-darkBackground mb-4 font-montserrat uppercase">
                  {benefit.title}
                </h3>
                <p className="text-darkBackground leading-relaxed text-lg font-playfair">
                  {benefit.description}
                </p>
              </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-mediumGreenAccent to-logoGreen rounded-2xl p-1 max-w-4xl mx-auto">
            <div className="bg-whiteAccent rounded-xl p-8">
              ...
              <button className="bg-gradient-to-r from-mediumGreenAccent to-logoGreen text-darkBackground px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 font-montserrat uppercase">
