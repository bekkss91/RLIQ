...
const Hero = () => {
  return (
    <section className="relative h-[70vh] overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-end h-full">
        <div className="max-w-4xl">
          ...
          <div className="relative bg-whiteAccent/95 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-lightGreenAccent max-w-2xl mr-auto mb-8">
