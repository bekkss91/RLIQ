      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-light text-darkBackground leading-relaxed font-montserrat mb-12">
            As your <span className="text-mediumGreenAccent">tech stack</span> grows, are your <span className="font-playfair text-mediumGreenAccent italic">people</span><br />more in the dark then <em>ever</em>?
          </h1>
